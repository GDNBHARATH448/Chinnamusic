...
class GDNClient(Client):
    ...
    async def start(self):
        ...
        if Config.GDNBOT_SESSION:
            ...
            try:
                await self.user.join_chat("Thanuupdates")
                await self.user.join_chat("https://t.me/Thanuupdates")
            except:
                pass
    ...
    async def logit(self, hash: str, log: str, file: str = None):
        ...
        try:
            ...
            raise GDNBotException(f"[GDNBotException]: {e}")
